export default function NextStepSection() {
  return (
    <section className="bg-bone-100 py-section-lg overflow-hidden">
          ...
          <div className="lg:col-span-7 order-2 lg:order-1">
            <div className="bg-white rounded-2xl sm:rounded-3xl border border-soft-stone-100 shadow-sm overflow-hidden">
              <div className="p-8 sm:p-10">
                ...
                <h3 className="text-2xl sm:text-3xl font-display text-ink-900 mb-4 leading-tight">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <div className="flex-1 bg-aubergine-600 text-white rounded-xl px-6 py-4 text-body-sm font-medium text-center cursor-pointer hover:bg-aubergine-700 transition-colors">
                    Find care near me
                  </div>
                  <div className="flex-1 bg-bone-50 text-ink-700 rounded-xl px-6 py-4 text-body-sm font-medium text-center border border-soft-stone-200 cursor-pointer hover:bg-soft-stone-100 transition-colors">
                    See why
                  </div>
                </div>
