...
export default function PhotoBreakSection() {
  ...
  return (
    <section ref={sectionRef} className={`photo-reveal ${isInView ? 'is-visible' : ''} relative min-h-[80vh] flex items-center justify-center overflow-hidden`}>
      {/* Full-bleed photography — human moment, intentional crop */}
      <div className="absolute inset-0">
        <img
          src="/images/human-break.jpg"
          alt=""
          className="photo-reveal-image w-full h-full object-cover object-[center_25%] sm:object-center photo-warm"
        />
      ...
      <div className={`marketing-reveal ${isInView ? 'is-visible' : ''} relative z-10 text-center px-5 max-w-2xl`}>
