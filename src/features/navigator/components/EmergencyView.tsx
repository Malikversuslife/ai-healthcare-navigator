...
function EmergencyView() {
  return (
    <div className="max-w-lg mx-auto text-center py-8 sm:py-12 px-2">
      ...
      <a
        ...
        className="inline-flex min-h-11 items-center justify-center px-8 py-4 bg-red-600 text-white rounded-2xl font-semibold text-body-lg hover:bg-red-700 transition-colors mb-4"
      >
