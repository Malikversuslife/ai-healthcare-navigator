      ...
      {useBrowser === null && (
        <div className="space-y-3">
          <button
            ...
            className="w-full min-h-11 px-4 py-3 bg-aubergine-600 text-white rounded-xl font-medium hover:bg-aubergine-700 transition-colors flex items-center justify-center gap-2"
          >
          ...
          <button
            ...
            className="w-full min-h-11 px-4 py-3 bg-white border border-ink-200 text-ink-700 rounded-xl font-medium hover:border-aubergine-300 transition-colors"
          >
          ...
          {onSkip && (
            <button
              type="button"
              onClick={onSkip}
              className="w-full min-h-11 px-4 py-2 text-ink-500 text-sm hover:text-ink-700 transition-colors"
            >
              Skip for now
            </button>
          )}
        ...
        <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-2">
              {NIGERIAN_CITIES.map((city) => (
                <button
                  ...
                  className="min-h-11 px-3 py-2 bg-ink-50 border border-ink-200 rounded-lg text-sm text-ink-700 hover:border-aubergine-300 hover:bg-aubergine-50 transition-colors text-left"
                >
                  {city}
                </button>
              ))}
          ...
          <form onSubmit={handleManualSubmit} className="flex gap-2">
            ...
            <button
              ...
              className="min-h-11 px-4 py-2 bg-aubergine-600 text-white rounded-xl font-medium hover:bg-aubergine-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
              Search
            </button>
          </form>
          ...
          <button
            ...
            className="min-h-11 inline-flex items-center text-sm text-ink-500 hover:text-ink-700 transition-colors"
          >
            ← Back to options
          </button>
        </div>
